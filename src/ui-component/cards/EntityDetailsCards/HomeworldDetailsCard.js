...
import { DetailsPageCards, NoDataCard } from 'ui-component';

const HomeworldDetailsCard = ({ entity, isWookiee }) => {
    return entity.data[getTranslation('homeworld', isWookiee)] ? (
        <DetailsPageCards
            categories={[entity.data[getTranslation('homeworld', isWookiee)]]}
            svgIcon={planetIcon}
            category="planets"
...
HomeworldDetailsCard.propTypes = {
    entity: PropTypes.object,
    isWookiee: PropTypes.bool
};

export default HomeworldDetailsCard;
